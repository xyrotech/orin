...
trait CollectionTrait
{
    ...
    public function add_to_collection_folder(string $username, int $folder_id, int $release_id): array
    {
    ...
    public function delete_instance_from_folder(string $username, int $folder_id, int $release_id, int $instance_id): array
    {
