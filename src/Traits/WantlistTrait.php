...
trait WantlistTrait
{
     ...
     * @return object
     */
    public function edit_from_wantlist(string $username, int $release_id, string $notes = null, int $rating = null) : object
    {
        $this->parameters = ['json' => ['notes' => $notes, 'rating' => $rating]];

        return $this->response('POST', "/users/$username/wants/$release_id");
    }
